import { definePacket, fshort, int16, int32, int8, leveldata, string, uint8 } from "./serde";
...
export const ExtInfo = definePacket(0x10, {
    appName: string(),
    extensionCount: int16(),
});

export const ExtEntry = definePacket(0x11, {
    name: string(),
    version: int32(),
});
